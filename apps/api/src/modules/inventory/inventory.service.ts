...
import type { Part, PartCategory, ToolLoan } from "../../../generated/prisma/client.js"
import type {
...
export const getParts = async (categoryId?: string): Promise<PartWithCategory[]> => {
...
export const updatePart = async (id: string, input: UpdatePartInput): Promise<Part> => {
...
export const getToolLoans = async (userId?: string): Promise<ToolLoanWithRelations[]> => {
...
export const createToolLoan = async (
    ...
    if (existingLoan) {
        throw new HTTPException(400, { message: "You already have this tool on loan" })
    }
...
export const returnToolLoan = async (
    ...
    if (loan.userId !== userId) {
        throw new HTTPException(403, { message: "You can only return your own loans" })
    }
