import { z } from 'zod'
import { UserRole, CertificationType } from '../../../generated/prisma/client.js'
...
export const createCertificationSchema = z.object({
    type: z.enum(Object.values(CertificationType) as [CertificationType, ...CertificationType[]]),
    issuedAt: z.coerce.date(),
    expiresAt: z.coerce.date()
}).refine(
    (data) => data.expiresAt > data.issuedAt,
