...
import type { CreateMachineInput, UpdateMachineInput, UpdateOperatingHoursInput } from "./machines.schema.js"
import type { Machine, MachineDocument } from "../../../generated/prisma/client.js"
...
export const getMachineById = async (id: string): Promise<MachineWithRelations> => {
...
export const createMachine = async (input: CreateMachineInput): Promise<Machine> => {
    ...
    if (existingMachine) {
        throw new HTTPException(409, { message: "Machine with this serial number already exists" })
    }
...
export const updateMachine = async (id: string, input: UpdateMachineInput): Promise<Machine> => {
...
export const getMachineDocuments = async (machineId: string): Promise<MachineDocument[]> => {
