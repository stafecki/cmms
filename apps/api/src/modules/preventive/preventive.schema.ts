...
const basePreventivePlanSchema = z.object({
  ...
  advanceDays: z
    .number()
    .int()
    .min(1, 'Advance days must be at least 1')
    .default(7),
  checklist: z
    .array(
      z.object({
...
export type CreatePreventivePlanInput = z.infer<
  typeof createPreventivePlanSchema
>
export type UpdatePreventivePlanInput = z.infer<
  typeof updatePreventivePlanSchema
>
